...
export async function generateMetadata({
  ...
  const title =
    savings > 0
      ? `This team could save $${savings.toFixed(0)}/mo on AI tools`
      : "This team's AI spend is optimized";

  return {
    title,
    description: `Team of ${data.team_size} · ${data.use_case} use case · Audited by SpendLens`,
    openGraph: {
      title,
      description: `Team of ${data.team_size} · ${data.use_case} use case · Audited by SpendLens`,
      url: `https://spendlens-taupe-eight.vercel.app/audit/${id}`,
      siteName: "SpendLens",
    },
    twitter: {
      card: "summary",
